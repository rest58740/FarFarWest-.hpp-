...
// BlueprintGeneratedClass BP_FeedbackBoard.BP_FeedbackBoard_C
// 0x0020 (0x02D0 - 0x02B0)
class ABP_FeedbackBoard_C final : public AActor
{
public:
	...
	class UUI_FeedbackBoard_C*                    UI_FeedbackBoard;                                  // 0x02C8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)

public:
	void ExecuteUbergraph_BP_FeedbackBoard(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_FeedbackBoard_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_FeedbackBoard_C")
	}
	static class ABP_FeedbackBoard_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_FeedbackBoard_C>();
	}
};
// DUMPER7_ASSERTS_ABP_FeedbackBoard_C;
