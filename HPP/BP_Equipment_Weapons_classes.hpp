...
// BlueprintGeneratedClass BP_Equipment_Weapons.BP_Equipment_Weapons_C
// 0x0028 (0x02D8 - 0x02B0)
class ABP_Equipment_Weapons_C final : public AActor
{
public:
	...
	class FText                                   Interactable_Datas_Title;                          // 0x02C8(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
...
public:
	...
	void ExecuteUbergraph_BP_Equipment_Weapons(int32 EntryPoint);

public:
	static class UClass* StaticClass()
	{
		BP_STATIC_CLASS_IMPL("BP_Equipment_Weapons_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_Equipment_Weapons_C")
	}
	static class ABP_Equipment_Weapons_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_Equipment_Weapons_C>();
	}
};
// DUMPER7_ASSERTS_ABP_Equipment_Weapons_C;
