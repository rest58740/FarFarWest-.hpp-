...
// BlueprintGeneratedClass BP_JoinDiscord.BP_JoinDiscord_C
// 0x0020 (0x02D0 - 0x02B0)
class ABP_JoinDiscord_C final : public AActor
{
public:
...
public:
	void ExecuteUbergraph_BP_JoinDiscord(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_JoinDiscord_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_JoinDiscord_C")
	}
	static class ABP_JoinDiscord_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_JoinDiscord_C>();
	}
};
// DUMPER7_ASSERTS_ABP_JoinDiscord_C;
