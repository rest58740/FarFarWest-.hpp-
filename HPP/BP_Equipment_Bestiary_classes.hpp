...
// BlueprintGeneratedClass BP_Equipment_Bestiary.BP_Equipment_Bestiary_C
// 0x0018 (0x02C8 - 0x02B0)
class ABP_Equipment_Bestiary_C final : public AActor
{
public:
...
public:
	void ExecuteUbergraph_BP_Equipment_Bestiary(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_Equipment_Bestiary_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_Equipment_Bestiary_C")
	}
	static class ABP_Equipment_Bestiary_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_Equipment_Bestiary_C>();
	}
};
// DUMPER7_ASSERTS_ABP_Equipment_Bestiary_C;
