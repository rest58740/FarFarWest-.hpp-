...
// BlueprintGeneratedClass BP_SpellReset.BP_SpellReset_C
// 0x0028 (0x02D8 - 0x02B0)
class ABP_SpellReset_C final : public AActor
{
public:
	...
	class UNiagaraComponent*                      NS_PickableObject;                                 // 0x02C0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
...
public:
	void ExecuteUbergraph_BP_SpellReset(int32 EntryPoint);
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("BP_SpellReset_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"BP_SpellReset_C")
	}
	static class ABP_SpellReset_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_SpellReset_C>();
	}
};
// DUMPER7_ASSERTS_ABP_SpellReset_C;
